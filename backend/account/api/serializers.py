...
class UserUpdateSerializer(serializers.ModelSerializer):
  ...
  name = serializers.CharField(source = 'profile.name', max_length = 32, allow_blank = True)
  avatar = serializers.URLField(source = 'profile.avatar', allow_blank = True)
  status = serializers.CharField(source = 'profile.status', allow_blank = True, default = '', min_length = 0, max_length = 16)
  ...
  def update(self, instance, validated_data):
    ...
    current password must be 'endiliey' password instead of 'donaldtrump' password
    '''
    try:
